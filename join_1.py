...
new_column_2 = when(col("population").isNull(), (col("population_male") + col("population_female"))).otherwise(col("population"))
...
df_demo = df_demo.withColumn("population", new_column_2)
